...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param name_1 a string representing the first part of a Silly object's name.
     * @param name_2 a string representing the second part of a Silly object's name.
     */
    public Silly(String name_1, String name_2) {
